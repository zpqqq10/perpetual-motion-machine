...
@y = dso_local global [10 x i8] c"aaa\00\00\00\00\00\00\00", align 1

; Function Attrs: noinline norecurse optnone uwtable
define dso_local i32 @main() #0 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  %2 = call i32 @_Z5printPc(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @y, i64 0, i64 0))
  ret i32 0
}

declare dso_local i32 @_Z5printPc(i8*) #1
