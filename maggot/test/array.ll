...
@__const.main.y = private unnamed_addr constant [10 x i8] c"aaa\00\00\00\00\00\00\00", align 1

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_Z9array_aaaPc(i8* %0) #0 {
  %2 = alloca i8*, align 8
...
define dso_local i32 @main() #1 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %3, i8* align 1 getelementptr inbounds ([10 x i8], [10 x i8]* @__const.main.y, i32 0, i32 0), i64 10, i1 false)
  %4 = getelementptr inbounds [10 x i8], [10 x i8]* %2, i64 0, i64 0
  %5 = call i32 @_Z9array_aaaPc(i8* %4)
  %6 = getelementptr inbounds [10 x i8], [10 x i8]* %2, i64 0, i64 0
  %7 = load i8, i8* %6, align 1
  %8 = call i32 @_Z7print_cc(i8 signext %7)
  ret i32 0
}
...
declare dso_local i32 @_Z7print_cc(i8 signext) #3
