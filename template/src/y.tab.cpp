...
static const yytype_uint8 yyrline[] =
{
      ...
      85,    89,    94,    95,    96,    99,   100,   103,   104,   108,
     112,   121,   124,   125,   126,   127,   128,   129,   130,   134,
     135,   140,   141,   145,   149,   150,   154,   155,   159,   160,
     163,   164,   165,   166,   167,   168,   169,   174,   175,   176,
     180,   181,   182,   185,   186,   187,   188,   189,   192,   193,
     194,   195,   196,   200,   204,   205,   208,   209
};
#endif
...
#line 58 "src/maggot.ypp"
               {(yyval.node) = (yyvsp[0].node); dynamic_cast<VarDeclList *>(yyval.node)->setGlobal(true);}
...
#line 104 "src/maggot.ypp"
                                                    {(yyval.node) = new ParmVarDeclAST(*(yyvsp[-2].str)); dynamic_cast<ParmVarDeclAST *>(yyval.node)->settype((yyvsp[-3].valueType) + TYPEARRAY);}
...
#line 129 "src/maggot.ypp"
                   {(yyval.node) = (yyvsp[0].node); dynamic_cast<VarDeclList *>(yyval.node)->setGlobal(false);}
#line 1736 "src/y.tab.cpp"
    break;

  case 38:
#line 130 "src/maggot.ypp"
                  {(yyval.node) = nullptr;}
